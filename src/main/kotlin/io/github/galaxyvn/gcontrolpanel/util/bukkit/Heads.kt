package io.github.galaxyvn.gcontrolpanel.util.bukkit
...
object Heads {
        ...
        when {
            ...
            Bukkit.getPlayer(name)?.isOnline == true -> {
                ...
                submit(async = true) {
                    ...
                    if (profile == null) {
                        console().sendMessage("§7[§3Texture§7] Ngoại hình người chơi $name không tìm thấy.")
                        return@submit
                    }
    ...
    private fun modifyTexture(input: String, itemStack: ItemStack): ItemStack {
        ...
        profile.properties.put("textures", Property("textures", texture, "GControlPanel_TexturedSkull"))
